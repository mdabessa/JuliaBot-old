...
entity.Command(
    ...
    func=exe,
    category=category,
    desc=f"Executar um comando através do bot.",
    args=[["comando", "*"], ["parametros do comando", ""]],
    perm=2,
)
...
entity.Command(
    ...
    category=category,
    desc="Listar todos os scripts rodando.",
    aliases=["gas"],
    perm=2,
)
...
entity.Command(
    name="get_allowed_bots",
    func=get_allowed_bots,
    category=category,
    desc="Listar todos os bots permitidos.",
    aliases=["gab"],
    perm=2,
)
    ...
    if commandpar != None:
        ...
        if str(commandpar) in bots:
            raise entity.CommandError(
                "Esse id de bot, ja esta registrado como um `allowed_bot`"
            )
...
entity.Command(
    name="add_allowed_bot",
    func=add_allowed_bot,
    category=category,
    desc="Permitir com que um bot especifico seja respondido.",
    aliases=["aab"],
    args=[["bot_id", "*"]],
    perm=2,
)
...
entity.Command(
    name="del_allowed_bot",
    func=del_allowed_bot,
    category=category,
    desc="Remover um bot especifico da lista de bots permitidos.",
    aliases=["dab"],
    args=[["bot_id", "*"]],
    perm=2,
)
